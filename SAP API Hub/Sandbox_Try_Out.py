...
aggregation: "{"TotalPackages":226,"PackageType":{"SAP Cloud Platform Open Connectors":{"count":29},"SAP API Management":{"count":197}},"TotalArtifacts":3316,"ArtifactType":{"API":{"subType":{"REST":{"count":1173},"ODATA":{"count":734},"ODATAV4":{"count":425},"SOAP":{"count":964}},"count":3296},"PolicyTemplate":{"count":20}}}"
},
{
name: "Events",
displayName: "Events",
shortText: "Explore all events in the SAP API Business Hub.",
description: "Explore all events from SAP API Business Hub.",
type: "contentType",
icon: "Event",
expression: [
{
...
createdBy: "XXX",
modifiedBy: "XXX",
createdDate: 1639118870876,
modifiedDate: 1662370894876,
aggregation: "{"TotalPackages":11,"PackageType":{"SAP Event":{"count":11}},"TotalArtifacts":285,"ArtifactType":{"Event":{"count":285}}}"
},
{
name: "Integration",
displayName: "Integrations",
shortText: "Explore integrations between different products.",
description: "Explore all integration content from SAP and partners.",
type: "contentType",
icon: "IFlow",
expression: [
{
...
createdBy: "XXX",
modifiedBy: "XXX",
createdDate: 1639118870870,
modifiedDate: 1662370894876,
aggregation: "{"TotalPackages":435,"PackageType":{"SAP HANA Cloud Integration":{"count":435}},"TotalArtifacts":2802,"ArtifactType":{"IFlow":{"count":2586},"OData Service":{"count":2},"IntegrationAdapter":{"subType":{"Storage":{"count":1}},"count":1},"ValueMapping":{"count":186},"ScriptCollection":{"count":12},"MessageMapping":{"count":15}}}"
},
{
name: "Adapter",
displayName: "Adapters",
shortText: "Explore all integration adapters or connections from SAP and Partners.",
description: "Explore all adapters or connections from SAP and partners.",
type: "contentType",
icon: "IntegrationAdapter",
expression: [
{
key: "supportedPlatforms",
operator: "=",
...
createdBy: "XXX",
modifiedBy: "XXX",
createdDate: 1652970005393,
modifiedDate: 1662370894880,
aggregation: "{"TotalPackages":1,"PackageType":{"SAP HANA Cloud Integration":{"count":1}},"TotalArtifacts":1,"ArtifactType":{"IntegrationAdapter":{"subType":{"Storage":{"count":1}},"count":1}}}"
},
{
name: "Workflow",
displayName: "Workflow Management",
shortText: "Explore all Workflow content packages from SAP Workflow Management.",
description: "Seamlessly integrate SAP products using business processes",
type: "contentType",
icon: "product",
expression: [
{
...
createdBy: "XXX",
modifiedBy: "XXX",
createdDate: 1639118870883,
modifiedDate: 1662370894880,
aggregation: "{"TotalPackages":91,"PackageType":{"SAP Cloud Platform Business Rules":{"count":8},"SAP Intelligent Business Process Management":{"count":83}},"TotalArtifacts":234,"ArtifactType":{"BusinessRules":{"count":6},"BRProject":{"count":99},"VisibilityScenario":{"count":70},"Process":{"count":59}}}"
},
{
name: "SAPGraph",
displayName: "SAP Graph",
shortText: "One connection to all business data.",
description: "Build extensions with a single OData v4 API   exposing a consolidated data graph with thousands of connected entities supporting SAP S/4HANA, SAP SuccessFactors and SAP Sales Cloud.",
type: "contentType",
createdBy: "XXX",
modifiedBy: "XXX",
createdDate: 1645773155436,
modifiedDate: 1662370894883
},
{
name: "CDSViews",
displayName: "CDS Views",
shortText: "Explore CDS view content from SAP.",
description: "Explore all CDS views from SAP S/4HANA Cloud.",
type: "contentType",
icon: "CDSVIEW",
expression: [
{
...
createdBy: "XXX",
modifiedBy: "XXX",
createdDate: 1639118870890,
modifiedDate: 1662370894886,
aggregation: "{"TotalPackages":8,"PackageType":{"SAP S/4 HANA":{"count":8}},"TotalArtifacts":5503,"ArtifactType":{"CDSVIEW":{"count":5503}}}"
},
{
name: "OpenConnectors",
displayName: "Open Connectors",
shortText: "Discover prebuilt connectors for seamless integration.",
type: "contentType",
icon: "abs-open-connectors",
expression: [
{
key: "supportedPlatforms",
operator: "=",
...
createdBy: "XXX",
modifiedBy: "XXX",
createdDate: 1639118870896,
modifiedDate: 1662370894886,
aggregation: "{"TotalPackages":29,"PackageType":{"SAP Cloud Platform Open Connectors":{"count":29}},"TotalArtifacts":170,"ArtifactType":{"API":{"subType":{"REST":{"count":170}},"count":170}}}"
},
{
name: "BusinessProcesses",
displayName: "Business Processes",
shortText: "Explore Business Processes for faster and seamless integration.",
type: "contentType",
icon: "Scenario",
expression: [
{
...
createdBy: "XXX",
modifiedBy: "XXX",
createdDate: 1639118870900,
modifiedDate: 1662370894886,
aggregation: "{"TotalPackages":23,"PackageType":{"SAP Enterprise Architect Designer":{"count":23}},"TotalArtifacts":351,"ArtifactType":{"Scenario":{"subType":{"Business Process Diagram":{"count":261},"Data Flow Diagram":{"count":44},"Value Flow Diagram":{"count":23},"Scenario Implementation":{"count":23}},"count":351}}}"
},
{
name: "ODM",
displayName: "One Domain Model",
shortText: "Discover One Domain Model content for deep out-of-the box integration, easy extension, and consistent API’s across business processes for the Intelligent Enterprise.",
type: "contentType",
icon: "tree",
createdBy: "XXX",
modifiedBy: "XXX",
createdDate: 1639118870886,
modifiedDate: 1662370894890
},
{
name: "DataIntelligence",
displayName: "Data Intelligence",
shortText: "Find and connect data assets to transform them to critical business insights.",
type: "contentType",
icon: "DataHub Solutions",
expression: [
{
key: "supportedPlatforms",
operator: "=",
...
createdBy: "XXX",
modifiedBy: "XXX",
createdDate: 1639118870903,
modifiedDate: 1662370894893,
aggregation: "{"TotalPackages":2,"PackageType":{"SAP DataHub":{"count":2}},"TotalArtifacts":2,"ArtifactType":{"DataHub Solutions":{"count":2}}}"
}
]
}"""
...
get_ipython().system('pip install dirtyjson')
